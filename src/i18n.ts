...
const messages: Record<SupportedLanguage, Messages> = {
  en: {
    ...
    codexLatestHint: "latest frontier agentic coding model",
    codexMiniHint: "smaller frontier agentic coding model",
    codexCodingHint: "frontier Codex-optimized agentic coding model",
    codexFrontierHint: "frontier agentic coding model",
    codexProHint: "optimized for professional work and long-running agents",
    codexMaxHint: "Codex-optimized model for deep and fast reasoning",
    codexLiteHint: "optimized for codex, cheaper, faster, but less capable",
    ...
    wizardModelIntro: "Choose which AI model the gateway will use.",
    ...
    accountsList: "Configured accounts",
    accountAdd: "Add account",
    accountRemove: "Remove account",
    accountReset: "Reset quotas",
    accountNone: "No accounts configured. Using default installation.",
    accountProvider: "Which provider?",
    accountAuthOAuth: "OAuth (login)",
    accountAuthOAuthHeadless: "OAuth headless (device auth)",
    accountAuthApiKey: "API Key",
    accountLabelPrompt: "Account label",
    accountLabelPlaceholder: "e.g. Work account",
    accountApiKeyPrompt: "API key",
    accountApiKeyPlaceholder: "sk-...",
    accountProvisioning: "Setting up account...",
    accountLoginRunning: "Opening login flow... Follow the instructions in your browser.",
    accountLoginSuccess: "Login successful! Account added.",
    accountLoginFailed: "Login failed. Please try again.",
    accountDefaultRegistered: (provider: string) => `Default ${provider} installation registered for rotation.`,
    accountAdded: (label: string) => `Account "${label}" added successfully.`,
    accountRemoved: (label: string) => `Account "${label}" removed.`,
    accountRotated: (from: string, to: string) => `\u26A0\uFE0F Quota limit on "${from}". Switching to "${to}".`,
    accountAllExhausted: "\u274C All accounts have hit their quota limits. Try again later or run: clink accounts reset",
    accountQuotaReset: "\u2705 Quotas reset. Back to first account.",
    accountRemoveWhich: "Which account to remove?",
    accountActive: "active",
    accountExhausted: "exhausted",
    accountSwitch: "Switch account",
    accountSwitchProvider: "Switch which provider?",
    accountSwitchWhich: "Switch to which account?",
    accountSwitched: (label: string) => `Switched to "${label}".`,
  },
  pt: {
    ...
    codexLatestHint: "modelo agentico de codigo mais recente",
    codexMiniHint: "modelo agentico de codigo menor",
    codexCodingHint: "modelo agentico Codex-otimizado",
    codexFrontierHint: "modelo agentico de codigo frontier",
    codexProHint: "otimizado para trabalho profissional e agentes de longa duracao",
    codexMaxHint: "modelo Codex-otimizado para raciocinio profundo e rapido",
    codexLiteHint: "otimizado para codex, mais barato, mais rapido, menos capaz",
    ...
    wizardModelIntro: "Escolha qual modelo de IA o gateway vai usar.",
    ...
    menuAccounts: "Gerenciar contas",
    accountsTitle: "Rodizio de Contas",
    accountsList: "Contas configuradas",
    accountAdd: "Adicionar conta",
    accountRemove: "Remover conta",
    accountReset: "Resetar quotas",
    accountNone: "Nenhuma conta configurada. Usando instalacao padrao.",
    accountProvider: "Qual provider?",
    accountAuthOAuth: "OAuth (login)",
    accountAuthOAuthHeadless: "OAuth headless (device auth)",
    accountAuthApiKey: "API Key",
    accountLabelPrompt: "Nome da conta",
    accountLabelPlaceholder: "ex: Conta trabalho",
    accountApiKeyPrompt: "Chave da API",
    accountApiKeyPlaceholder: "sk-...",
    accountProvisioning: "Configurando conta...",
    accountLoginRunning: "Abrindo fluxo de login... Siga as instrucoes no navegador.",
    accountLoginSuccess: "Login bem-sucedido! Conta adicionada.",
    accountLoginFailed: "Falha no login. Tente novamente.",
    accountDefaultRegistered: (provider: string) => `Instalacao padrao do ${provider} registrada para rodizio.`,
    accountAdded: (label: string) => `Conta "${label}" adicionada com sucesso.`,
    accountRemoved: (label: string) => `Conta "${label}" removida.`,
    accountRotated: (from: string, to: string) => `\u26A0\uFE0F Quota da conta "${from}" esgotada. Usando "${to}" agora.`,
    accountAllExhausted: "\u274C Quota esgotada em todas as contas. Tente mais tarde ou use: clink accounts reset",
    accountQuotaReset: "\u2705 Quotas resetadas. Voltando para a primeira conta.",
    accountRemoveWhich: "Qual conta remover?",
    accountActive: "ativa",
    accountExhausted: "esgotada",
    accountSwitch: "Trocar conta",
    accountSwitchProvider: "Trocar conta de qual provider?",
    accountSwitchWhich: "Trocar para qual conta?",
    accountSwitched: (label: string) => `Trocado para "${label}".`,
  },
  es: {
    ...
    codexLatestHint: "modelo agentico de codigo mas reciente",
    codexMiniHint: "modelo agentico de codigo mas pequeno",
    codexCodingHint: "modelo agentico Codex-optimizado",
    codexFrontierHint: "modelo agentico de codigo frontier",
    codexProHint: "optimizado para trabajo profesional y agentes de larga duracion",
    codexMaxHint: "modelo Codex-optimizado para razonamiento profundo y rapido",
    codexLiteHint: "optimizado para codex, mas barato, mas rapido, menos capaz",
    ...
    wizardModelIntro: "Elige que modelo de IA usara el gateway.",
    ...
    menuAccounts: "Gestionar cuentas",
    accountsTitle: "Rotacion de Cuentas",
    accountsList: "Cuentas configuradas",
    accountAdd: "Agregar cuenta",
    accountRemove: "Eliminar cuenta",
    accountReset: "Resetear quotas",
    accountNone: "Ninguna cuenta configurada. Usando instalacion predeterminada.",
    accountProvider: "Cual proveedor?",
    accountAuthOAuth: "OAuth (login)",
    accountAuthOAuthHeadless: "OAuth headless (device auth)",
    accountAuthApiKey: "API Key",
    accountLabelPrompt: "Nombre de la cuenta",
    accountLabelPlaceholder: "ej: Cuenta trabajo",
    accountApiKeyPrompt: "Clave API",
    accountApiKeyPlaceholder: "sk-...",
    accountProvisioning: "Configurando cuenta...",
    accountLoginRunning: "Abriendo flujo de login... Sigue las instrucciones en el navegador.",
    accountLoginSuccess: "Login exitoso! Cuenta agregada.",
    accountLoginFailed: "Fallo en el login. Intenta de nuevo.",
    accountDefaultRegistered: (provider: string) => `Instalacion predeterminada de ${provider} registrada para rotacion.`,
    accountAdded: (label: string) => `Cuenta "${label}" agregada exitosamente.`,
    accountRemoved: (label: string) => `Cuenta "${label}" eliminada.`,
    accountRotated: (from: string, to: string) => `\u26A0\uFE0F Quota de la cuenta "${from}" agotada. Usando "${to}" ahora.`,
    accountAllExhausted: "\u274C Quota agotada en todas las cuentas. Intenta mas tarde o usa: clink accounts reset",
    accountQuotaReset: "\u2705 Quotas reseteadas. Volviendo a la primera cuenta.",
    accountRemoveWhich: "Cual cuenta eliminar?",
    accountActive: "activa",
    accountExhausted: "agotada",
    accountSwitch: "Cambiar cuenta",
    accountSwitchProvider: "Cambiar cuenta de cual proveedor?",
    accountSwitchWhich: "Cambiar a cual cuenta?",
    accountSwitched: (label: string) => `Cambiado a "${label}".`,
  },
};
