const messages = {
  en: {
    ...
    wizardDone: "Setup complete! Run 'cgram gateway' or select Start gateway from the menu.",
  ...
  pt: {
    ...
    wizardDone: "Configuracao completa! Rode 'cgram gateway' ou selecione Iniciar gateway no menu.",
